...
import '../DMPage/index.scss';
import animate from 'css-animation';
import Menu, { SubMenu, Item as MenuItem, Divider } from '../../../package/rc-menu';
...
class Demo extends Component {
    ...
    renderCommonMenu = (props = {}) => {
        return (
            <Menu onClick={this.handleClick} onOpenChange={this.onOpenChange} {...props} motion={animation}>
